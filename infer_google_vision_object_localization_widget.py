...
from infer_google_vision_object_localization.infer_google_vision_object_localization_process import InferGoogleVisionObjectLocalizationParam
...
# --------------------
class InferGoogleVisionObjectLocalizationWidget(core.CWorkflowTaskWidget):

    def __init__(self, param, parent):
        core.CWorkflowTaskWidget.__init__(self, parent)

        if param is None:
            self.parameters = InferGoogleVisionObjectLocalizationParam()
        else:
...
# --------------------
class InferGoogleVisionObjectLocalizationWidgetFactory(dataprocess.CWidgetFactory):

    def __init__(self):
        dataprocess.CWidgetFactory.__init__(self)
        # Set the algorithm name attribute -> it must be the same as the one declared in the algorithm factory class
        self.name = "infer_google_vision_object_localization"

    def create(self, param):
        # Create widget object
        return InferGoogleVisionObjectLocalizationWidget(param, None)
